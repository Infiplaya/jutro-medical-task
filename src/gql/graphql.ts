...
export type GetCountryQuery = { __typename?: 'Query', country?: { __typename?: 'Country', name: string, code: string, emoji: string, languages: Array<{ __typename?: 'Language', name?: string | null }> } | null };
