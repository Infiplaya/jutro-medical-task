  ...
  if (data) {
    ...
    return (
      <>
        ...
        <div className="flex min-h-screen w-full flex-col items-center justify-center bg-gradient-to-tr from-green-300 via-blue-500 to-purple-600 text-xl text-white">
          <section>
